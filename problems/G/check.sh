...
bash judge.sh code/bruckets.cpp 2 9
bash judge.sh code/meet_in_the_middle.cpp 2 10
bash judge.sh code/two_parts_random.cpp 4 11
bash judge.sh code/mod/mod_one_prime.cpp 1 9
bash judge.sh code/mod/mod_two_primes.cpp 2 10
bash judge.sh code/mod/mod_1e6.cpp 3 10
